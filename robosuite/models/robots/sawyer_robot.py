...
class Sawyer(Robot):
    ...
    def velocity_pid_gains(self):
        return {'right_j0': {'p': 5* 8.0, 'i': 0.001, 'd':  0.001},
                    'right_j1': {'p': 5* 7.0, 'i': 0.001, 'd':  0.001},
                    'right_j2': {'p':5* 6.0, 'i': 0.001, 'd': 0.001},
                    'right_j3': {'p':5* 4.0, 'i': 0.001, 'd': 0.001},
                    'right_j4': {'p':5* 2.0, 'i': 0.001, 'd': 0.001},
                    'right_j5': {'p': 5* 0.5, 'i': 0.001, 'd': 0.001},
                    'right_j6': {'p':5* 0.1, 'i': 0.001, 'd':  0.001},
                    }
